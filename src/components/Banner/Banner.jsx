...
const oneWayTrip1 = () => {
  ...
  setairportActive(false)
  setValue(1)
  document.getElementById('chilla').style.marginBottom='224px';
}
...
const roundTrip1 = () => {
  ...
  setrentalActive(false)
  setairportActive(false)
  document.getElementById('chilla').style.marginBottom='300px';
}
...
const rental1 = () => {
  ...
  setroundActive(false)
  setairportActive(false)
  document.getElementById('chilla').style.marginBottom='156px';
}
...
const airport1 = () => {
  ...
  setroundActive(false)
  setrentalActive(false)
  document.getElementById('chilla').style.marginBottom='290px';
}
